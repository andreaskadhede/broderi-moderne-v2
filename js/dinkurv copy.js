...
let produktPrice = document.querySelectorAll(".pris-per-stk");
let productName = document.querySelectorAll(".navn-produkt");
let productImage = document.querySelectorAll(".billede-produkt")

produktPrice.textContent = `${item.price.toFixed(2)} DKK`;
